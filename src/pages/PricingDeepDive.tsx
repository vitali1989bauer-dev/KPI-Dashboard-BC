    ...
    <div>
      ...
      <div className="grid grid-cols-3 gap-4 mb-6">
        <div className="bg-card rounded-xl border border-border p-5 card-hover">
          ...
          <p className="text-2xl font-bold text-text-primary">&euro; 201.5</p>
          <div className="flex items-center gap-1 mt-1">
            <ArrowUpRight className="w-3.5 h-3.5 text-positive" />
            <span className="text-xs font-semibold text-positive">+3.5% vs LY</span>
          </div>
        </div>
        <div className="bg-card rounded-xl border border-border p-5 card-hover">
          <p className="text-xs font-semibold text-text-muted uppercase tracking-wide mb-1">
          ...
          <div className="flex items-center gap-1 mt-1">
            <ArrowUpRight className="w-3.5 h-3.5 text-positive" />
            <span className="text-xs font-semibold text-positive">+0.6pp vs LY</span>
          </div>
        </div>
        <div className="bg-card rounded-xl border border-border p-5 card-hover">
          <p className="text-xs font-semibold text-text-muted uppercase tracking-wide mb-1">
          ...
          <div className="flex items-center gap-1 mt-1">
            ...
            <span className="text-xs font-semibold text-negative">-1.2% vs LY</span>
          </div>
        </div>
      </div>
          ...
          <table className="w-full">
            ...
            <tbody>
              {pricingDeepDiveData.map((row, idx) => (
                ...
                >
                  <td className="px-6 py-3.5 text-sm font-semibold text-text-primary">
                    {row.segment}
                  </td>
