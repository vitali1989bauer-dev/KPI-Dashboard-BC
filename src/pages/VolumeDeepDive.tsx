...
import { volumeDeepDiveData } from '../data/mockData'

export default function VolumeDeepDive() {
  const totalActual = volumeDeepDiveData.reduce((sum, d) => sum + d.actual, 0)
  const totalForecast = volumeDeepDiveData.reduce((sum, d) => sum + d.forecast, 0)
