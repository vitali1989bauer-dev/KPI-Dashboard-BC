...
export interface PriceEngineRow {
  ...
  volumeTargetMT: number       // annual volume target in metric tons
  volumeActualMT: number       // volume achieved YTD
}
...
export function getPriceEngineRows(f: Filters): PriceEngineRow[] {
  return [
    ...
    { id: 'pe-1', region: 'Europe', customerType: 'A', customer: 'BayWa', product: 'MOP', targetPrice: vary(700, f, 2000), limitPrice: vary(300, f, 2001), targetMargin: vary(20, f, 2002), limitMargin: vary(10, f, 2003), strategy: 'price-driven', currency: '€/t', anchorMarket: null, isAnchor: true, alertField: null, volumeTargetMT: Math.round(vary(120000, f, 4000)), volumeActualMT: Math.round(vary(98000, f, 4001)) },
    { id: 'pe-2', region: 'Europe', customerType: 'A', customer: 'AGRAVIS', product: 'SOP', targetPrice: vary(900, f, 2010), limitPrice: vary(500, f, 2011), targetMargin: vary(25, f, 2012), limitMargin: vary(12, f, 2013), strategy: 'volume-driven', currency: '€/t', anchorMarket: null, isAnchor: true, alertField: 'targetPrice', volumeTargetMT: Math.round(vary(85000, f, 4010)), volumeActualMT: Math.round(vary(72000, f, 4011)) },
    { id: 'pe-3', region: 'Europe', customerType: 'B', customer: 'Raiffeisen', product: 'Korn-Kali\u00AE', targetPrice: vary(650, f, 2020), limitPrice: vary(280, f, 2021), targetMargin: vary(22, f, 2022), limitMargin: vary(11, f, 2023), strategy: 'price-driven', currency: '€/t', anchorMarket: null, isAnchor: false, alertField: null, volumeTargetMT: Math.round(vary(45000, f, 4020)), volumeActualMT: Math.round(vary(41000, f, 4021)) },
    // --- North America anchor market ---
    { id: 'pe-4', region: 'North America', customerType: 'A', customer: 'Nutrien', product: 'MOP', targetPrice: vary(420, f, 2030), limitPrice: vary(200, f, 2031), targetMargin: vary(18, f, 2032), limitMargin: vary(9, f, 2033), strategy: 'volume-driven', currency: '$/t', anchorMarket: null, isAnchor: true, alertField: 'limitPrice', volumeTargetMT: Math.round(vary(200000, f, 4030)), volumeActualMT: Math.round(vary(155000, f, 4031)) },
    { id: 'pe-5', region: 'North America', customerType: 'B', customer: 'Mosaic', product: 'MOP', targetPrice: vary(400, f, 2040), limitPrice: vary(190, f, 2041), targetMargin: vary(16, f, 2042), limitMargin: vary(8, f, 2043), strategy: 'price-driven', currency: '$/t', anchorMarket: 'pe-4', isAnchor: false, alertField: null, volumeTargetMT: Math.round(vary(95000, f, 4040)), volumeActualMT: Math.round(vary(62000, f, 4041)) },
    // --- South America (anchored to North America) ---
    { id: 'pe-6', region: 'South America', customerType: 'A', customer: 'Fertipar', product: 'MOP', targetPrice: vary(380, f, 2050), limitPrice: vary(180, f, 2051), targetMargin: vary(15, f, 2052), limitMargin: vary(7, f, 2053), strategy: 'volume-driven', currency: '$/t', anchorMarket: 'pe-4', isAnchor: false, alertField: 'targetMargin', volumeTargetMT: Math.round(vary(75000, f, 4050)), volumeActualMT: Math.round(vary(48000, f, 4051)) },
    { id: 'pe-7', region: 'South America', customerType: 'B', customer: 'Heringer', product: 'SOP', targetPrice: vary(520, f, 2060), limitPrice: vary(250, f, 2061), targetMargin: vary(17, f, 2062), limitMargin: vary(8, f, 2063), strategy: 'price-driven', currency: '$/t', anchorMarket: null, isAnchor: false, alertField: null, volumeTargetMT: Math.round(vary(40000, f, 4060)), volumeActualMT: Math.round(vary(38000, f, 4061)) },
    // --- Asia Pacific ---
    { id: 'pe-8', region: 'Asia Pacific', customerType: 'A', customer: 'Sinofert', product: 'MOP', targetPrice: vary(360, f, 2070), limitPrice: vary(170, f, 2071), targetMargin: vary(14, f, 2072), limitMargin: vary(6, f, 2073), strategy: 'volume-driven', currency: '$/t', anchorMarket: null, isAnchor: false, alertField: null, volumeTargetMT: Math.round(vary(180000, f, 4070)), volumeActualMT: Math.round(vary(110000, f, 4071)) },
    { id: 'pe-9', region: 'Asia Pacific', customerType: 'B', customer: 'IPL', product: 'CMS', targetPrice: vary(290, f, 2080), limitPrice: vary(140, f, 2081), targetMargin: vary(13, f, 2082), limitMargin: vary(6, f, 2083), strategy: 'price-driven', currency: '$/t', anchorMarket: null, isAnchor: false, alertField: null, volumeTargetMT: Math.round(vary(30000, f, 4080)), volumeActualMT: Math.round(vary(22000, f, 4081)) },
    // --- Overseas (anchored to Europe) ---
    { id: 'pe-10', region: 'Overseas', customerType: 'A', customer: 'OCP Group', product: 'CMS', targetPrice: vary(310, f, 2090), limitPrice: vary(150, f, 2091), targetMargin: vary(16, f, 2092), limitMargin: vary(7, f, 2093), strategy: 'volume-driven', currency: '$/t', anchorMarket: 'pe-1', isAnchor: false, alertField: null, volumeTargetMT: Math.round(vary(60000, f, 4090)), volumeActualMT: Math.round(vary(35000, f, 4091)) },
  ]
}
