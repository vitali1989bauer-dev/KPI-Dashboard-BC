...
const skusByFamily: Record<string, { sku: string; desc: string; lp: number; np: number; cogs: number; qty: number }[]> = {
  'Coupling Plates': [
    ...
    { sku: 'VT-CP-2043-M', desc: 'Coupling plate 300mm military spec', lp: 385, np: 298, cogs: 145, qty: 42 },
    { sku: 'VT-CP-2044-W', desc: 'Coupling plate wear ring set', lp: 78, np: 52, cogs: 34, qty: 620 },
  ],
  'Sealing Rings': [
    ...
    { sku: 'VT-SR-1030', desc: 'Mechanical face seal 80mm SiC', lp: 145, np: 108, cogs: 58, qty: 95 },
    { sku: 'VT-SR-1031', desc: 'Backup ring PTFE 45mm', lp: 12, np: 8, cogs: 4, qty: 890 },
  ],
  'VSP Controls': [
    { sku: 'VT-VSP-5001', desc: 'VSP control unit MkIV complete', lp: 4800, np: 4560, cogs: 1820, qty: 12 },
    { sku: 'VT-VSP-5002', desc: 'VSP control board PCB replacement', lp: 3200, np: 2980, cogs: 1240, qty: 18 },
    ...
    { sku: 'VT-VSP-5020', desc: 'VSP pitch control linkage', lp: 1850, np: 1720, cogs: 680, qty: 6 },
  ],
  'Thrust Bearings': [
    ...
    { sku: 'VT-TB-4021', desc: 'Thrust bearing shoe (individual)', lp: 185, np: 148, cogs: 82, qty: 210 },
    { sku: 'VT-TB-4030', desc: 'Tilting pad journal bearing set', lp: 1580, np: 1320, cogs: 720, qty: 18 },
  ],
  'OS Oil Filters': [
    { sku: 'VT-OF-3010', desc: 'Oil filter element 10μm cellulose', lp: 185, np: 128, cogs: 82, qty: 180 },
    { sku: 'VT-OF-3011', desc: 'Oil filter element 25μm pleated', lp: 165, np: 118, cogs: 74, qty: 120 },
    { sku: 'VT-OF-3020', desc: 'Filter housing assy. DN100 CS', lp: 580, np: 420, cogs: 285, qty: 48 },
    { sku: 'VT-OF-3021', desc: 'Bypass valve cartridge 3 bar', lp: 320, np: 245, cogs: 162, qty: 32 },
    { sku: 'VT-OF-3030', desc: 'Duplex filter switchover valve', lp: 890, np: 685, cogs: 420, qty: 15 },
  ],
  'Filter Elements': [
    { sku: 'VT-FE-2010', desc: 'Hydraulic return filter 10μm', lp: 52, np: 34, cogs: 21, qty: 480 },
    { sku: 'VT-FE-2011', desc: 'Hydraulic pressure filter 5μm', lp: 78, np: 55, cogs: 32, qty: 320 },
    { sku: 'VT-FE-2020', desc: 'Air breather filter element', lp: 35, np: 24, cogs: 14, qty: 560 },
    { sku: 'VT-FE-2021', desc: 'Suction strainer 100 mesh', lp: 42, np: 28, cogs: 16, qty: 290 },
  ],
  'Shaft Seals': [
    { sku: 'VT-SS-3010', desc: 'Stern tube seal (fwd) complete', lp: 148, np: 118, cogs: 62, qty: 165 },
    { sku: 'VT-SS-3011', desc: 'Stern tube seal (aft) complete', lp: 162, np: 132, cogs: 68, qty: 148 },
    { sku: 'VT-SS-3020', desc: 'Seal ring set Chrome/PTFE', lp: 85, np: 68, cogs: 35, qty: 280 },
    { sku: 'VT-SS-3021', desc: 'Seal carrier bronze machined', lp: 220, np: 178, cogs: 98, qty: 72 },
  ],
  'Gear Wheels': [
    { sku: 'VT-GW-4010', desc: 'Helical gear wheel z=42 m=8', lp: 620, np: 498, cogs: 285, qty: 85 },
    { sku: 'VT-GW-4011', desc: 'Helical pinion z=18 m=8', lp: 480, np: 395, cogs: 218, qty: 85 },
    { sku: 'VT-GW-4020', desc: 'Bevel gear set spiral', lp: 1150, np: 920, cogs: 542, qty: 28 },
    { sku: 'VT-GW-4021', desc: 'Spur gear z=64 m=5 case hardened', lp: 340, np: 272, cogs: 152, qty: 120 },
  ],
  'Prop. Blades': [
    { sku: 'VT-PB-5010', desc: 'CPP blade CuNiAl size 4', lp: 2800, np: 2520, cogs: 1120, qty: 24 },
    { sku: 'VT-PB-5011', desc: 'CPP blade CuNiAl size 5', lp: 3400, np: 3060, cogs: 1380, qty: 18 },
    { sku: 'VT-PB-5020', desc: 'Blade bolt set M48 Inconel', lp: 480, np: 432, cogs: 185, qty: 45 },
    { sku: 'VT-PB-5021', desc: 'Blade seal carrier complete', lp: 1250, np: 1120, cogs: 480, qty: 12 },
  ],
  'Impeller Units': [
    { sku: 'VT-IU-5030', desc: 'Impeller assy. bronze size 3', lp: 3200, np: 2880, cogs: 1280, qty: 15 },
    { sku: 'VT-IU-5031', desc: 'Impeller assy. bronze size 4', lp: 3800, np: 3420, cogs: 1520, qty: 12 },
    { sku: 'VT-IU-5040', desc: 'Wear ring set impeller/casing', lp: 420, np: 378, cogs: 145, qty: 38 },
    { sku: 'VT-IU-5041', desc: 'Impeller hub adapter ring', lp: 680, np: 612, cogs: 265, qty: 22 },
  ],
  'Control Valves': [
    { sku: 'VT-CV-3510', desc: 'Proportional valve DN25 24VDC', lp: 285, np: 228, cogs: 128, qty: 92 },
    { sku: 'VT-CV-3511', desc: 'Directional valve 4/3 DN20', lp: 195, np: 156, cogs: 85, qty: 145 },
    { sku: 'VT-CV-3520', desc: 'Pressure relief valve 350 bar', lp: 165, np: 132, cogs: 72, qty: 180 },
  ],
  'Pressure Sensors': [
    { sku: 'VT-PS-1510', desc: 'Pressure transmitter 0-250 bar', lp: 142, np: 108, cogs: 62, qty: 95 },
    { sku: 'VT-PS-1511', desc: 'Pressure switch 0-400 bar ATEX', lp: 185, np: 142, cogs: 78, qty: 65 },
    { sku: 'VT-PS-1520', desc: 'Temperature sensor PT100 L=200', lp: 68, np: 52, cogs: 28, qty: 180 },
  ],
  'Clutch Discs': [
    { sku: 'VT-CD-3810', desc: 'Friction disc organic Ø380', lp: 245, np: 198, cogs: 108, qty: 120 },
    { sku: 'VT-CD-3811', desc: 'Friction disc sintered Ø380', lp: 385, np: 312, cogs: 168, qty: 65 },
    { sku: 'VT-CD-3820', desc: 'Separator plate hardened Ø380', lp: 95, np: 76, cogs: 42, qty: 240 },
    { sku: 'VT-CD-3821', desc: 'Clutch spring pack (12 pcs)', lp: 128, np: 102, cogs: 55, qty: 85 },
  ],
}
